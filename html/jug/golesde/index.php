...
$(document).ready(function() {
	...
	if($(this).hasClass("active")) {
		...
		$.post( "./golesde/filtrarnombres.php", {'pos':'def'}, function (data) { 
	...
	if($(this).hasClass("active")) {
		...
		$.post( "./golesde/filtrarnombres.php", {'pos':'por'}, function (data) { 
		$("#mostrarJug").prepend(data); //Se muestra el resultado de la operación en la clase 
		});
	...
	if($(this).hasClass("active")) {
		...
		$.post( "./golesde/filtrarnombres.php", {'pos':'cen'}, function (data) { 
		$("#mostrarJug").prepend(data); //Se muestra el resultado de la operación en la clase 
		});
	...
	if($(this).hasClass("active")) {
		...
		$.post( "./golesde/filtrarnombres.php", {'pos':'del'}, function (data) { 
		$("#mostrarJug").prepend(data); //Se muestra el resultado de la operación en la clase 
		});
	...
	if($(this).hasClass("active")) {
		...
		$.post( "./golesde/filtrarnombres.php", {'pos':'arb'}, function (data) { 
		$("#mostrarJug").prepend(data); //Se muestra el resultado de la operación en la clase 
		});
	...
	if($(this).hasClass("active")) {
		...
		$.post( "./golesde/filtrarnombres.php", {'pos':'extran'}, function (data) { 
		$("#mostrarJug").prepend(data); //Se muestra el resultado de la operación en la clase 
		});
		}
	else {
		$(".ARB,.DEL,.CEN,.DEF,.POR").remove();
		$.post( "./golesde/filtrarnombres.php", {'pos':'extras'}, function (data) { 
		$("#mostrarJug").prepend(data); //Se muestra el resultado de la operación en la clase 
		});
	...
	$.post( "./golesde/vergolesunJug.php", {'jugador':$(this).attr("id")}, function (data) { 
...
<div id="elegirTemp" class="col-md-12 col-sm-12" style="min-height:400px;overflow-y:auto;">
