...
<input id="jug" type="hidden" value="<?php echo $_SESSION['usu']; ?>" />
...
<div id="elegirTemp" style="height:400px;">
<?php
...
ORDER BY p.fecha DESC ";
	...
	<div id="infopartido" class="col-md-8 col-sm-8" style="min-height:536px;background-color:rgba(12,12,12,0.3);">
	<div id="drcha" class="col-md-12 col-sm-12" style="min-height:520px;max-height:500px;overflow-y:auto;">
	</div>
	</div>
	<?php }
	else { ?>
