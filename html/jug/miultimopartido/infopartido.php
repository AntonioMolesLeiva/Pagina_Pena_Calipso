...
LIMIT 0 , 1
	*/
	...
	echo "<h1>Éste jugador no ha jugado aún</h1>";
	}
	
	$instruccion="SELECT * FROM partido WHERE fecha='".$fechapartido."'";
	$consulta = mysql_query ($instruccion, $conexion)
				or die ("FALLO EN LA CONSULTA $instruccion");			
	$nfilas = mysql_num_rows ($consulta);
	if ($nfilas>0) {
...
<div class="col-sm-4 col-md-4" style="overflow:auto;height:520px;padding:0px !important;">
			...
			<div id="portero" class="divPosiciones">
				...
				$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
					fecha='".$fechapartido."' AND local='s' AND posicion='por'";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
			...
			<?php
				if ($def==5) {
				$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
					fecha='".$fechapartido."' AND local='s' AND posicion='def'";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
								$nfilas = mysql_num_rows ($consulta);
			...
			<?php
				if ($cen==5) {
				$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
					fecha='".$fechapartido."' AND local='s' AND posicion='cen'";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
								$nfilas = mysql_num_rows ($consulta);
			...
			<?php
				if ($del==5) {
				$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
					fecha='".$fechapartido."' AND local='s' AND posicion='del'";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
								$nfilas = mysql_num_rows ($consulta);
...
<div class="col-sm-4 col-md-4" style="overflow:auto;height:520px;padding:0px !important;">
			...
			<div id="portero" class="divPosiciones">
				...
				<?php
				$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
					fecha='".$fechapartido."' AND local='n' AND posicion='por'";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
				$resultado=mysql_fetch_array ($consulta);
			...
			<?php
				if ($def==5) {
				$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
					fecha='".$fechapartido."' AND local='n' AND posicion='def'";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
								$nfilas = mysql_num_rows ($consulta);
			...
			<?php
				if ($cen==5) {
				$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
					fecha='".$fechapartido."' AND local='n' AND posicion='cen'";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
								$nfilas = mysql_num_rows ($consulta);
			...
			<?php
				if ($del==5) {
				$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
					fecha='".$fechapartido."' AND local='n' AND posicion='del'";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
								$nfilas = mysql_num_rows ($consulta);
	...
	<div class="panel panel-info col-md-12 col-sm-12">
			...
			<div class="table-responsive">
					<table class="col-md-12 col-sm-12" style="margin:auto;">
						...
						where fecha='".$fechapartido."' AND local='s'
	...
	<?php
					 ...
					 LEFT JOIN jugador j ON i.jugador=j.dni
					 where fecha='".$fechapartido."' AND posicion='A'";
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
					$nfilas = mysql_num_rows ($consulta);
					if ($nfilas>0) {
	...
	$instruccion="SELECT j.alias,j.dni,j.dorsal,j.foto FROM incidencia i
					 LEFT JOIN jugador j ON i.jugador=j.dni
					 where fecha='".$fechapartido."' AND posicion IS NULL";
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
					$nfilas = mysql_num_rows ($consulta);
					if ($nfilas>0) {
...
*/
	...
	/*Hay estrategia de 1*/
		...
		<div class="table-responsive">
			...
			fecha='".$fechapartido."' AND local='n' ORDER BY posicion asc";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
					$nfilas = mysql_num_rows ($consulta);
		...
		<div class="table-responsive">
			...
			$instruccion="SELECT j.alias,j.dni,i.gol,i.idsancion FROM incidencia i LEFT JOIN jugador j ON i.jugador=j.dni where
			fecha='".$fechapartido."' AND local='s' ORDER BY posicion asc";	
					$consulta = mysql_query ($instruccion, $conexion)
								or die ("FALLO EN LA CONSULTA $instruccion");
					$nfilas = mysql_num_rows ($consulta);
		...
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tbody>
					...
					$instruccion="SELECT j.alias,j.dni,i.jugador,i.idsancion,i.gol,i.local,i.posicion FROM incidencia i
						LEFT JOIN jugador j ON i.jugador=j.dni
						where fecha='".$fechapartido."' AND local='n'
						ORDER BY `local` ASC,posicion asc";
