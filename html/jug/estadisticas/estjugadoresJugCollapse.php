...
$(function () {
    $('#nvecespos').highcharts({
		...
		echo "<h3>Éste jugador en ésta temporada (".($_POST['anomax']-1)." / ".$_POST['anomax'].") no ha cambiado de posición</h3>";
		}
 ?>
</div>
...
$(function () {
    $('#partjug').highcharts({
		...
		echo "<h3>En ésta temporada (".($_POST['anomax']-1)." / ".$_POST['anomax'].") no has jugado ningún partido</h3>";
		}
 ?>
</div>
