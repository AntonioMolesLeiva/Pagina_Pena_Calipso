...
<div class="panel panel-default negroTransparente">
  <div id="cabeceraSelectPartidos" class="panel-heading" style="text-align:center;">Jugador</div>
  <div class="panel-body miboton" style="height:70px;overflow:auto;">
	<a id="<?php echo $_SESSION['usu']; ?>" class="buttontemp azul" style="width:100%;text-align:center;">Yo</a>
  </div>
</div>
</div>
<div class="col-md-12 col-sm-12">
